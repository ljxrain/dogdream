...
"造梦家"是一款基于AI技术的创意内容生成应用，为用户提供照片艺术化处理、视频生成、表情包制作等功能，并支持将创意作品实体化的电商服务。本文档旨在为开发团队提供详细的开发指南和技术规范。

### 1.1 产品定位

造梦家面向普通消费者，提供简单易用的AI创意内容生成服务，让用户能够轻松将普通照片转换为艺术作品，并支持将数字作品实体化（如打印、定制商品等）。
